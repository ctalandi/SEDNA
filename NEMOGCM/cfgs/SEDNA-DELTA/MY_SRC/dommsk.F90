...
!CT Mask few open water closed areas { 
      IF(lwp) THEN
         WRITE(numout,*)
         WRITE(numout,*) ' >>>>>>>>>>>>>>>>>>>>>              CAUTION: Mask few open areas by hand before correction of the bathy file'
         WRITE(numout,*)
         WRITE(numout,*) '                                            CPUS concerned: #01761' 
      ENDIF

      ! The following grid points are located on the eastern side of the BAFFIN bay
      ii0 = 1600   ;   ii1 = 1600
      ij0 = 1865   ;   ij1 = 1867   ;   tmask( mi0(ii0):mi1(ii1),mj0(ij0):mj1(ij1),:) = 0._wp

      ii0 = 1600   ;   ii1 = 1600
      ij0 = 1819   ;   ij1 = 1822   ;   tmask( mi0(ii0):mi1(ii1),mj0(ij0):mj1(ij1),:) = 0._wp

      ii0 = 1599   ;   ii1 = 1599
      ij0 = 1819   ;   ij1 = 1821   ;   tmask( mi0(ii0):mi1(ii1),mj0(ij0):mj1(ij1),:) = 0._wp

      ii0 = 1600   ;   ii1 = 1600
      ij0 = 1786   ;   ij1 = 1788   ;   tmask( mi0(ii0):mi1(ii1),mj0(ij0):mj1(ij1),:) = 0._wp

      ii0 = 1599   ;   ii1 = 1600
      ij0 = 1763   ;   ij1 = 1765   ;   tmask( mi0(ii0):mi1(ii1),mj0(ij0):mj1(ij1),:) = 0._wp

      ii0 = 1600   ;   ii1 = 1600
      ij0 = 1641   ;   ij1 = 1643   ;   tmask( mi0(ii0):mi1(ii1),mj0(ij0):mj1(ij1),:) = 0._wp

      
      ii0 = 1472   ;   ii1 = 1476
      ij0 = 2312   ;   ij1 = 2320   ;   tmask( mi0(ii0):mi1(ii1),mj0(ij0):mj1(ij1),:) = 0._wp

      ii0 = 1478   ;   ii1 = 1489
      ij0 = 2300   ;   ij1 = 2327   ;   tmask( mi0(ii0):mi1(ii1),mj0(ij0):mj1(ij1),:) = 0._wp

      ii0 = 1485   ;   ii1 = 1491
      ij0 = 2327   ;   ij1 = 2337   ;   tmask( mi0(ii0):mi1(ii1),mj0(ij0):mj1(ij1),:) = 0._wp

      ii0 = 1523   ;   ii1 = 1526
      ij0 = 2340   ;   ij1 = 2340   ;   tmask( mi0(ii0):mi1(ii1),mj0(ij0):mj1(ij1),:) = 0._wp

      ii0 = 1536   ;   ii1 = 1543
      ij0 = 2323   ;   ij1 = 2337   ;   tmask( mi0(ii0):mi1(ii1),mj0(ij0):mj1(ij1),:) = 0._wp

      ii0 = 1494   ;   ii1 = 1498
      ij0 = 2394   ;   ij1 = 2396   ;   tmask( mi0(ii0):mi1(ii1),mj0(ij0):mj1(ij1),:) = 0._wp
